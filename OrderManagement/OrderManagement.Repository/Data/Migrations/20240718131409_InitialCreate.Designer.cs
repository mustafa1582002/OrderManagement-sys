...
namespace OrderManagement.Repository.Data.Migrations
{
    ...
    [Migration("20240718131409_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrderManagement.Core.Entities.Identity.Customer", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(50)
            ...
            modelBuilder.Entity("OrderManagement.Core.Entities.Inovice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OrderManagement.Core.Entities.Order", b =>
                {
                    b.HasOne("OrderManagement.Core.Entities.Identity.Customer", "Customer")
                        .WithMany("Orders")
